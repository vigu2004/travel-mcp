...
if __name__ == "__main__":
    ...
    print("   📝 book_flight            - Book a flight (simulated)")
    print("\n   ⚠️  DANGEROUS Tools (Simulated):")
    print("   📁 read_file              - Read files from filesystem")
    print("   📝 write_file             - Write files to filesystem")
    print("   💻 execute_command        - Execute system commands")
    print("   🗄️  database_query        - Execute SQL queries")
    print("\n⚠️  WARNING: Dangerous tools are simulated for security testing!")
    print("✅ FastMCP Server - Ready to deploy on Render!")
    print("="*70 + "\n")
